                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">support@expenso.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">+60 3-1234 5678</p>
                            </div>
                        </div>
                        ...
                        <div class="pt-8">
                            ...
                            <div class="flex space-x-4">
                                <a href="#" class="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-colors">
                ...
                <div data-aos="fade-left" class="bg-white rounded-2xl shadow-lg p-8">
                    <form @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <button
                            ...
                            class="w-full bg-indigo-600 text-white px-6 py-4 rounded-lg hover:bg-indigo-700 transition-all transform hover:scale-105 font-medium disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none">
