                    ...
                    <div class="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-8">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <button
                                    :disabled="pending"
                                    class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    @click="refresh"
                                >
