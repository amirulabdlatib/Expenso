            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col items-end space-y-2">
                        ...
                        <button class="flex items-center justify-center w-12 h-12 text-gray-500 hover:text-gray-700 transition-colors" :title="isAmountVisible ? 'Hide amounts' : 'Show amounts'" @click="toggleAmountVisibility">
