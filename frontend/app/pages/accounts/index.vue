            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <button :class="[filterType === 'credit' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200', 'px-4 py-2 rounded-lg transition-colors text-sm font-medium']" @click="filterType = 'credit'">
                            Credit Card
                        </button>
                    ...
                    <div :style="{ background: `linear-gradient(135deg, ${account.color} 0%, ${account.color}dd 100%)` }" class="p-6 text-white relative">
                        <div class="flex items-start justify-between mb-8">
                            ...
                            <div class="flex items-center space-x-1">
                                ...
                                <button class="p-2 hover:bg-white hover:bg-opacity-20 rounded-lg transition-colors" @click="deleteAccount(account.id)">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div v-if="account.type === 'Credit Card'" class="pt-4 border-t border-gray-100">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div :style="{ width: account.creditUsage + '%' }" class="bg-gradient-to-r from-green-500 to-red-500 h-2 rounded-full"/>
                            </div>
